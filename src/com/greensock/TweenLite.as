package com.greensock
{
   ...
   public class TweenLite extends TweenCore
   {
      ...
      public function TweenLite(target:Object, duration:Number, vars:Object)
      {
         ...
         propTweenLookup = {};
         _ease = defaultEase;
         _overwrite = Number(vars.overwrite) <= -1 || !overwriteManager.enabled && vars.overwrite > 1 ? int(overwriteManager.mode) : int(vars.overwrite);
      ...
      protected function init() : void
      {
         ...
         {
            if(Boolean(overwriteManager.manageOverwrites(this,this.propTweenLookup,siblings,_overwrite)))
            {
               init();
            }
         }
