package com.game.modules.view.person.actAI
{
   ...
   public class NPC22013 extends SceneAIBase
   {
      ...
      private var _hasClickList:Array = [];
      
      private var _hasItemIdx:int;
      ...
      public function NPC22013(param:Object)
      {
         ...
         this._hasClickList = [];
         this._hasItemIdx = Math.floor(Math.random() * 3);
         this._curIdx = 2;
         param.url += ".swf";
      }
      ...
      private function playOver() : void
      {
         this.showMaster();
         this._isPlay = false;
         this._mcList[this._curClickMc].visible = true;
         this._mcList[this._curClickMc].gotoAndStop(1);
         ++this._count;
         if(this._count >= 3 || this._curIdx == this._hasItemIdx)
         {
      ...
      private function onMouseClick(evt:MouseEvent) : void
      {
         ...
         this._curIdx = index;
         if(this._hasClickList.indexOf(index) > -1)
         {
            AlertManager.instance.addTipAlert({
               "tip":"这里已经挖过了",
               "type":1
