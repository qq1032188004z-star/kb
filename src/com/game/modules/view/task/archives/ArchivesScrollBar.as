package com.game.modules.view.task.archives
{
   ...
   public class ArchivesScrollBar extends Sprite
   {
      ...
      public function updateScrollBarButtons(flag:Boolean) : void
      {
         ...
         if(flag)
         {
            ...
            this.target.addEventListener(MouseEvent.MOUSE_UP,this.stopScroll);
         ...
         else
         {
            ...
            this.target.removeEventListener(MouseEvent.MOUSE_UP,this.stopScroll);
