package com.game.modules.action
{
   ...
   public class SwfRotationAction
   {
      ...
      public function SwfRotationAction(loadedcallback:Function = null)
      {
         super();
      ...
      public function loadAndPlay(parent:DisplayObjectContainer, url:String, xCoord:Number, yCoord:Number, rotation:Number = 0, complement:Function = null, data:Object = null, specialAction:Function = null, specialFrame:int = 0, callback:Function = null, isRemove:Boolean = true) : void
      {
         this.parent = parent;
         this.xCoord = xCoord;
         this.yCoord = yCoord;
      ...
      private function onLoaded(evt:Event) : void
      {
         ...
         this.movieClip.rotation = this.rotation;
